      ...
      <div className="mx-auto max-w-xl px-5">
        <form className="flex gap-2">
          ...
          <input
            ...
            id="value"
            autoComplete="off"
            className="block w-20 rounded-md border-0 px-3 py-1.5 text-sm text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
            placeholder="Value"
          />
